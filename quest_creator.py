...
def QuestSettings(tab, data, onAreaChange=None, onArenaToggle=None):
    ...
    ToolTipCheckbutton(questFlagsFrame1, "This flag sets the Quest list display to 2 portraits, causes the first\n Subquest to be required for Quest completion, and merges the first Subquest's\nobjective counter with the Main Objective's in the Quest Info menu.", text="Two Objectives", variable=var12).pack(side='top', anchor=N+W)
    ToolTipCheckbutton(questFlagsFrame1, "This flag causes the programmed Boss monsters to spawn one-after-the-other,\nwith the next appearing after the previous is defeated. It also causes both\nSubquests to be required for completion in addition to the Main Objective\n and merges their objective counters with the Main Objective's.", text="Marathon Mode", variable=var13).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame1, text="UNK SET 2", variable=var14).pack(side='top', anchor=N+W)
    ...
    var27 = flags[1][6]
    var28 = flags[1][7]
    ttk.Checkbutton(questFlagsFrame2, text="Allow Day", variable=var21).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame2, text="Allow Night", variable=var22).pack(side='top', anchor=N+W)
    ToolTipCheckbutton(questFlagsFrame2, "This flag causes all Subquests to be required for completion in addition to the Main Objective.", text="All Objectives", variable=var23).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame2, text="UNK SET 3", variable=var24).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame2, text="\"Qualifying Time\"", variable=var25).pack(side='top', anchor=N+W)
    ToolTipCheckbutton(questFlagsFrame2, "This flag is responsible for the hr1 Festival of Fear and the offline Trial of the\nSea Dragon/Save Moga Village! repel behavior. It also disables the Final Showdown\nand changes Jhen's AI, and causes Subquest completion to not be announced.", text="Repel Behavior", variable=var26).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame2, text="UNK SET 4", variable=var27).pack(side='top', anchor=N+W)
    ...
    var37 = flags[2][6]
    var38 = flags[2][7]
    ToolTipCheckbutton(questFlagsFrame3, "This flag sets the Quest list display to 2 monster portraits,\ndisplays no Subquests, causes Subquest 1 to be required,\nartificially marks the Quest as \"Unstable,\" and causes the\nmonster in the Boss 3 slot to spawn on a timer.", text="Hunter Killer", variable=var31).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame3, text="UNK SET 5", variable=var32).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame3, text="UNK SET 6", variable=var33).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame3, text="Banjo Music", variable=var34).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame3, text="UNK SET 7", variable=var35).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame3, text="UNK SET 8", variable=var36).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame3, text="UNK SET 9", variable=var37).pack(side='top', anchor=N+W)
    ttk.Checkbutton(questFlagsFrame3, text="UNK SET 10", variable=var38).pack(side='top', anchor=N+W)
...
def Objectives(tab, data):
    ...
    ttk.Checkbutton(mainFlagsFrame1, text="UNK OBJ 1", variable=varMain14).pack(side='top', anchor=N+W)
    ttk.Checkbutton(mainFlagsFrame1, text="Check On Timeout(?)", variable=varMain15).pack(side='top', anchor=N+W)
    ttk.Checkbutton(mainFlagsFrame1, text="UNK OBJ 2", variable=varMain16).pack(side='top', anchor=N+W)
    ttk.Checkbutton(mainFlagsFrame1, text="UNK OBJ 3", variable=varMain17).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(mainFlagsFrame2, text="UNK OBJ 4", variable=varMain24).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(mainFlagsFrame2, text="UNK OBJ 5", variable=varMain27).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(mainFlagsFrame3, text="UNK OBJ 6", variable=varMain33).pack(side='top', anchor=N+W)
    ttk.Checkbutton(mainFlagsFrame3, text="UNK OBJ 7", variable=varMain34).pack(side='top', anchor=N+W)
    ttk.Checkbutton(mainFlagsFrame3, text="UNK OBJ 8", variable=varMain35).pack(side='top', anchor=N+W)
    ttk.Checkbutton(mainFlagsFrame3, text="UNK OBJ 9", variable=varMain36).pack(side='top', anchor=N+W)
    ttk.Checkbutton(mainFlagsFrame3, text="UNK OBJ 10", variable=varMain37).pack(side='top', anchor=N+W)
    ttk.Checkbutton(mainFlagsFrame3, text="UNK OBJ 11", variable=varMain38).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(sub1FlagsFrame1, text="UNK OBJ 1", variable=varSub114).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame1, text="Check on Timeout(?)", variable=varSub115).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame1, text="UNK OBJ 2", variable=varSub116).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame1, text="UNK OBJ 3", variable=varSub117).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(sub1FlagsFrame2, text="UNK OBJ 4", variable=varSub124).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(sub1FlagsFrame2, text="UNK OBJ 5", variable=varSub127).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame2, text="Count Down Minions", variable=varSub128).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(sub1FlagsFrame3, text="Count Down Bugs", variable=varSub131).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame3, text="Count Down Bosses", variable=varSub132).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame3, text="UNK OBJ 6", variable=varSub133).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame3, text="UNK OBJ 7", variable=varSub134).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame3, text="UNK OBJ 8", variable=varSub135).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame3, text="UNK OBJ 9", variable=varSub136).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame3, text="UNK OBJ 10", variable=varSub137).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub1FlagsFrame3, text="UNK OBJ 11", variable=varSub138).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(sub2FlagsFrame1, text="UNK OBJ 1", variable=varSub214).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame1, text="Check on Timeout(?)", variable=varSub215).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame1, text="UNK OBJ 2", variable=varSub216).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame1, text="UNK OBJ 3", variable=varSub217).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(sub2FlagsFrame2, text="UNK OBJ 4", variable=varSub224).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(sub2FlagsFrame2, text="UNK OBJ 5", variable=varSub227).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame2, text="Count Down Minions", variable=varSub228).pack(side='top', anchor=N+W)
    ...
    ttk.Checkbutton(sub2FlagsFrame3, text="Count Down Bugs", variable=varSub231).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame3, text="Count Down Bosses", variable=varSub232).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame3, text="UNK OBJ 6", variable=varSub233).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame3, text="UNK OBJ 7", variable=varSub234).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame3, text="UNK OBJ 8", variable=varSub235).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame3, text="UNK OBJ 9", variable=varSub236).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame3, text="UNK OBJ 10", variable=varSub237).pack(side='top', anchor=N+W)
    ttk.Checkbutton(sub2FlagsFrame3, text="UNK OBJ 11", variable=varSub238).pack(side='top', anchor=N+W)
